...
/*   Updated: 2023/10/06 12:31:28 by antoda-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/myfdf.h"

void	rotationX(t_v3d *i, t_v3d *o, float theta)
{
	o->x = i->x;
...
void	rotationY(t_v3d *i, t_v3d *o, float theta)
{
...
void	rotationZ(t_v3d *i, t_v3d *o, float theta)
{
...
void	rotation(t_v3d *i, t_v3d *o, float thetaX, float thetaY, float thetaZ)
{
	...
	rotationX(i, &tmp, thetaX);
	rotationY(&tmp, o, thetaY);
	rotationZ(o, &tmp, thetaZ);
	*o = tmp;
	return ;
}
